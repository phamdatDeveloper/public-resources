package com.pdcoder.loans.controller;

import com.pdcoder.loans.constants.LoansConstants;
import com.pdcoder.loans.dto.ErrorResponseDto;
import com.pdcoder.loans.dto.LoansDto;
import com.pdcoder.loans.dto.ResponseDto;
...
@Tag(
        name = "CRUD REST APIs for Loans in PDBank",
        description = "CRUD REST APIs in PDBank to CREATE, UPDATE, FETCH AND DELETE loan details"
)
@RestController
